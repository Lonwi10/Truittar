<?php
session_start();
if(isset($_POST["enviarPost"]) && !empty($_POST["publi"])){
  enviarPubli($_SESSION["Id"], $_POST["publi"]);
}

else if(isset($_POST["enviarPost"]) && empty($_POST["publi"])){
?>
  <script type="text/javascript">
    alert('Truit vacio, introduce texto');
  </script>
<?php
}

if(isset($_POST["borrar"])){
  borrarPublic($_POST["borrar"]);
}
...
function borrarPublic($borr){
    ...
    <?php
      try{
        ...
        $query = $pdo->prepare("DELETE FROM publicacion WHERE ID ="."'".$borr."'");
        $query->execute();
...
<div class = "cuerpo">
    <div class = "postentero">
      <form action="" method="post">
        <div class="divpost">
          ...
          <br>
           <button type="submit" class="postear" name="enviarPost"> Truittear </button>
          <p>
        </div>
      </form>
    </div>
    ...
    <?php
          ...
          $q = "SELECT * FROM publicacion where creadorID = '".$_SESSION["Id"]."'";
          $query = $pdo->prepare($q);
          $query->execute();
          ...
          ?>
            ...
            <div class = "publicacionAutor">
              ...
              echo "<p class='aTexto'>".$nombre." ".$apellido." <span>@".$usuario."</span> ".$row["fecha"]."</p>";
              echo $row["descripcion"];

                ?>
                  <div class = "eliminar">
                    <form method='post'>
                      <button type="submit" class="postear" name="borrar" value=<?php echo "'".$row["ID"]."'"?> > X </button>
